...
const Quotes = () => {
    ...
    return(
        <div id="main" style={{ backgroundColor: `${changeColor}`,height:'100vh'}}>
            <h2 id="head"style={{marginLeft:400,fontSize:40,}}>Random Quote Generator </h2>
    <div>
        ...
        <div id="buttons" >
            <div className="social">
                <a href={`https://twitter.com/intent/tweet?text=${quote}`} id="tweet" target={"_blank"} >
                    <button id="media" style={{backgroundColor:`${changeColor}`,border:'none',borderRadius:3,color:'white',padding:'10'}}>Tweet</button>
                </a>
        ...
        <footer id="footer">OPEN SOURCE LICENSED</footer>
     </div>
    );
}
