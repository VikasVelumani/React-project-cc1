...
function App() {
    ...
    const [author, setAuthor] = useState('');
     function random(){
         let randomv= Math.floor(Math.random() * randomQuote    .length);
        setQuote(randomQuote[randomv].text);
        setAuthor(randomQuote[randomv].author);
    }
    return ( 
        <div id="main" >
            <div id="quote-box" style={{ backgroundColor: 'lightgrey' }}>
                ...
                <a href="https://www.tumblr.com/" id="tumble">
                    ...
                    <button onClick={random} id="new-quote" style={{ backgroundColor: 'blue' }}>New Quotes</button>
                </div>
            </div>
        </div>
     );
